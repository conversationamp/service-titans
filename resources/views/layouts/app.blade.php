...
<head>
    ...
    <!-- DataTables -->
    <link href="{{ asset_url('plugins/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset_url('plugins/datatables/buttons.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset_url('plugins/datatables/responsive.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- Sweet Alert -->
    <link href="{{ asset_url('plugins/sweet-alert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset_url('plugins/animate/animate.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset_url('plugins/dropify/css/dropify.min.css') }}" rel="stylesheet">

    <!-- Select2 -->
    <link href="{{ asset_url('plugins/select2/select2.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- Apex Charts -->
    <link href="{{ asset_url('plugins/apexcharts/dist/apexcharts.css') }}" rel="stylesheet" type="text/css" />

    <!-- Datepicker -->
    {{-- <link rel="stylesheet" type="text/css" href="jquery.datetimepicker.css" / > --}}
    <link href="{{ asset_url('plugins/timepicker/bootstrap-material-datetimepicker.css') }}" rel="stylesheet">
    ...
    <!-- App css -->
    <link href="{{ asset_url('assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset_url('assets/css/jquery-ui.min.css') }}" rel="stylesheet">
    <link href="{{ asset_url('assets/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset_url('assets/css/metisMenu.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset_url('assets/css/app.min.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset_url('assets/css/custom.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset_url('plugins/daterangepicker/daterangepicker.css') }}" rel="stylesheet" type="text/css" />
    <style>
        :root {
...
<body>
    ...
    <script src="{{ asset_url('assets/js/metismenu.min.js') }}"></script>
    <script src="{{ asset_url('assets/js/waves.js') }}"></script>
    <script src="{{ asset_url('assets/js/feather.min.js') }}"></script>
    ...
    <script src="{{ asset_url('plugins/datatables/dataTables.bootstrap4.min.js') }}"></script>

    <!-- Sweet-Alert  -->
    <script src="{{ asset_url('plugins/sweet-alert2/sweetalert2.min.js') }}"></script>
    <script src="{{ asset_url('/plugins/dropify/js/dropify.min.js') }}"></script>
    <script src="{{ asset_url('/plugins/uppy/uppy.min.js') }}"></script>
    ...
    <script src="{{ asset_url('plugins/moment/moment.js') }}"></script>
    <script src="{{ asset_url('plugins/daterangepicker/daterangepicker.js') }}"></script>
    <script src="{{ asset_url('plugins/timepicker/bootstrap-material-datetimepicker.js') }}"></script>

    <!-- Autocomplete jQuery  -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-autocomplete/1.0.7/jquery.auto-complete.min.js"></script>
    <script src="{{ asset_url('plugins/apexcharts/dist/apexcharts.js') }}"></script>
    <!-- App js -->
    ...
    <script>
        ...
        processErrors(@json($error_messages));
