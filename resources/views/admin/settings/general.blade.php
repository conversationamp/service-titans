                        ...
                        <form action="{{ route('setting.save') }}" method="POST" class="card-box"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="company_name" id="company_name"
                                    value="{{ get_values_by_id('company_name', login_id()) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="company_email" id="company_name"
                                    value="{{ get_values_by_id('company_email', login_id()) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control dropify" name="company_logo" id="company_logo"
                                    data-default-file="{{ asset(get_values_by_id('company_logo', login_id())) }}">
                            </div>
