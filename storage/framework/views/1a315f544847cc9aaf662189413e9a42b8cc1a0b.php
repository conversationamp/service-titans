...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        let table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo e(route($route . '.get-default', 0)); ?>",
            },
            columns: [{
                    data: 'pipeline_name',
                    name: 'pipeline_name'
        ...
        let table1 = $('#datatable1').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo e(route($route . '.get-default', 1)); ?>",
            },
            columns: [{
                    data: 'titan_location_name',
                    name: 'titan_location_name'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ServiceTitans\Service-Titans\resources\views/admin/sync-settings/make-default.blade.php ENDPATH**/ ?>